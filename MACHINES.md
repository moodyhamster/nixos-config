...
Each physical computer has a unique host directory with a shared machine base and a KDE Plasma system configuration.
...
- `configuration.nix` is the standard KDE compatibility entry point for that host.
...
## Lenovo ThinkPad C13 Yoga Chromebook Gen 1 - machine 2

- Managed hostname: `thinkpad-c13-2`
- User: `kim`
- Desktop: KDE Plasma 6
- CPU/GPU: AMD Ryzen 5 3500C with integrated Radeon Vega graphics
- Boot mode: UEFI
